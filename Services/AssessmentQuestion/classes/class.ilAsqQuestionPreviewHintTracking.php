...
/**
 * Class ilAsqQuestionPreviewHintTracking
 *
...
class ilAsqQuestionPreviewHintTracking
{
	...
	public function __construct(ilDBInterface $db, ilAsqQuestionPreviewSession $previewSession)
	{
		$this->db = $db;
	...
	public function getNextRequestableHint()
	{
		...
		throw new ilAssessmentQuestionException(
