...
/**
 * ilAsqQuestionPageGUI: Question page GUI class
 *
 * @author Alex Killing <alex.killing@gmx.de>
 * @author Björn Heyser <info@bjoernheyser.de>
 *
 * @ilCtrl_Calls ilAsqQuestionPageGUI: ilPageEditorGUI, ilEditClipboardGUI, ilMDEditorGUI
 * @ilCtrl_Calls ilAsqQuestionPageGUI: ilPublicUserProfileGUI, ilNoteGUI
 * @ilCtrl_Calls ilAsqQuestionPageGUI: ilPropertyFormGUI, ilInternalLinkGUI
 *
