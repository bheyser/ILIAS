 ...
 *
 * @ilCtrl_Calls ilAsqQuestionFeedbackEditingGUI: ilAssGenFeedbackPageGUI, ilAssSpecFeedbackPageGUI
 * @ilCtrl_Calls ilAsqQuestionFeedbackEditingGUI: ilPropertyFormGUI
 */
class ilAsqQuestionFeedbackEditingGUI
{
	/**
	 * command constants
	 */
