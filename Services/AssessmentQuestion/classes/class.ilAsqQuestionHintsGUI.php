 ...
 *
 * @ilCtrl_Calls ilAsqQuestionHintsGUI: ilAssQuestionHintGUI
 * @ilCtrl_Calls ilAsqQuestionHintsGUI: ilAssQuestionHintsTableGUI
 * @ilCtrl_Calls ilAsqQuestionHintsGUI: ilAssHintPageGUI
 * @ilCtrl_Calls ilAsqQuestionHintsGUI: ilToolbarGUI, ilConfirmationGUI
 */
class ilAsqQuestionHintsGUI extends ilAssQuestionHintAbstractGUI
{
	/**
	 * command constants
	 */
