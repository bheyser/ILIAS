 ...
 */
class assSourceCodeImport extends assQuestionImport
{
	/**
	...
	function fromXML(&$item, $questionpool_id, &$tst_id, &$tst_object, &$question_counter, &$import_mapping)
	{
		...
		$srcCodeLang = $this->object->sourceCodeLanguageFactory->getSourceCodeLanguageByIdentifier(
			$item->getMetadataEntry('SOURCE_CODE_LANG')
		);
		
		$this->object->setSourceCodeLanguage($srcCodeLang);
