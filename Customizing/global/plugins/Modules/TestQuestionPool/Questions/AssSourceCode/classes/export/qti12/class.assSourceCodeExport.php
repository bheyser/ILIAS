...
*/
class assSourceCodeExport extends assQuestionExport
{
	/**
	 * @var assSourceCode
	 */
	...
	*/
	function toXML($a_include_header = true, $a_include_binary = true, $a_shuffle = false, $test_output = false, $force_image_references = false)
	{
		...
		$a_xml_writer->xmlStartTag("qtimetadatafield");
		$a_xml_writer->xmlElement("fieldlabel", NULL, "SOURCE_CODE_LANG");
		$a_xml_writer->xmlElement("fieldentry", NULL, $this->object->getSourceCodeLanguage()->getIdentifier());
		$a_xml_writer->xmlEndTag("qtimetadatafield");
		...
		$a_xml_writer->xmlStartTag('render_fib', array(
			"fibtype" => "String",
			"prompt" => "Box"
		));
		$attrs = array( 'ident' => 'A' );
