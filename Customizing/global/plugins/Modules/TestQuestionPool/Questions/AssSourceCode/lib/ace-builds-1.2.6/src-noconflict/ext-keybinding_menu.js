...
module.exports.overlayPage = function overlayPage(editor, contentElement, top, right, bottom, left) {
	...
	// PATCH BEGIN: append to editor instance container
	$(closer).css('position', 'absolute');
	console.log(closer.style.cssText);
	// PATCH END: append to editor instance container
	...
	// PATCH BEGIN: append to editor instance container
	else $(editor.container).parent().find('.ilWebIde_Overlay').append(closer);
	// PATCH END: append to editor instance container
    editor.blur();
};
